    ...
    return (
        <>
            ...
            <div className="space-y-6">
                ...
                {/* Filter Modal */}
                <Modal show={showFilters} onClose={() => setShowFilters(false)} maxWidth="2xl">
                    <div className="p-6">
                        <div className="mb-5 flex items-center justify-between">
                            <div>
                                <h2 className="text-lg font-semibold text-slate-900 dark:text-white">Filter Produk</h2>
                                <p className="mt-0.5 text-sm text-slate-500 dark:text-slate-400">Saring dan urutkan daftar produk</p>
                            </div>
                            <button
                                type="button"
                        ...
                        <form onSubmit={applyFilters}>
                            ...
                            {/* Active filter chips inside modal */}
                            {activeFilterChips.length > 0 && (
                                <div className="mt-4 flex flex-wrap gap-2 rounded-xl bg-slate-50 p-3 dark:bg-slate-800/50">
                                    {activeFilterChips.map((chip) => (
                                        <span
                                            key={chip.key}
                                            className="rounded-full border border-primary-200 bg-primary-50 px-3 py-1 text-xs font-medium text-primary-700 dark:border-primary-900/40 dark:bg-primary-950/30 dark:text-primary-300"
                            ...
                            <div className="mt-5 flex flex-wrap justify-end gap-2 border-t border-slate-100 pt-5 dark:border-slate-800">
                                ...
                                <button
                                    type="submit"
                                    className="inline-flex items-center gap-2 rounded-xl bg-primary-500 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-primary-600"
                                >
                            ...
                            <Table>
                                <Table.Thead>
                                    <tr>
                                        ...
                                        <Table.Th>Rating & Terjual</Table.Th>
                                        <Table.Th></Table.Th>
                                    </tr>
                                </Table.Thead>
                                <Table.Tbody>
