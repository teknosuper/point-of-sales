...
Route::group(['prefix' => 'dashboard', 'middleware' => ['auth']], function () {
    ...
    Route::post('outlets', [OutletManagementController::class, 'store'])->middleware('permission:outlets-create')->name('outlets.store');
    Route::put('outlets/{outlet}', [OutletManagementController::class, 'update'])->middleware(['permission:outlets-update', 'outlet_access'])->name('outlets.update');
    Route::patch('outlets/{outlet}/toggle', [OutletManagementController::class, 'toggle'])->middleware(['permission:outlets-toggle', 'outlet_access'])->name('outlets.toggle');
    ...
    Route::post('audit-logs/cleanup', [AuditLogController::class, 'cleanup'])->middleware(['permission:audit-logs-access', 'step_up'])->name('audit-logs.cleanup');
    ...
    Route::get('/transaction-feedback', [TransactionFeedbackController::class, 'index'])->middleware('permission:reports-access')->name('transaction-feedback.index');
    ...
    Route::put('/settings/printer/cashier-receipt', [\App\Http\Controllers\Apps\PrinterSettingController::class, 'updateCashierReceipt'])->middleware(['permission:business-settings-update', 'outlet_access'])->name('settings.printer.cashier-receipt');
    ...
    Route::get('/settings/kitchen-devices/summary/{outlet}', [KitchenSettingsController::class, 'outletSummary'])->middleware(['permission:kitchen-manage', 'outlet_access'])->name('settings.kitchen-devices.summary');
    ...
    Route::post('/settings/kitchen-stations', [KitchenSettingsController::class, 'storeStation'])->middleware(['permission:kitchen-manage', 'outlet_access'])->name('settings.kitchen-stations.store');
    Route::put('/settings/kitchen-stations/{station}', [KitchenSettingsController::class, 'updateStation'])->middleware(['permission:kitchen-manage', 'outlet_access'])->name('settings.kitchen-stations.update');
    ...
    Route::post('/settings/kitchen-stations/{station}/devices', [KitchenSettingsController::class, 'storeDevice'])->middleware(['permission:kitchen-manage', 'outlet_access'])->name('settings.kitchen-devices.store');
    Route::put('/settings/kitchen-devices/{device}', [KitchenSettingsController::class, 'updateDevice'])->middleware(['permission:kitchen-manage', 'outlet_access'])->name('settings.kitchen-devices.update');
    Route::patch('/settings/kitchen-devices/{device}/toggle', [KitchenSettingsController::class, 'toggleDevice'])->middleware(['permission:kitchen-manage', 'outlet_access'])->name('settings.kitchen-devices.toggle');
